    ...
    public static class FrameworkElementAnimations
    {
        ...
        public static async Task SlideAndFadeInAsync(this FrameworkElement element, AnimationSlideInDirection direction, bool firstLoad, float seconds = 0.3f, bool keepMargin = true, int size = 0)
        {
            ...
            switch (direction)
            {
                ...
                case AnimationSlideInDirection.Left:
                    sb.AddSlideFromLeft(seconds, size == 0 ? element.ActualWidth / 20 : size, keepMargin: keepMargin);
                    break;
                // Add slide from left animation
                case AnimationSlideInDirection.LeftFully:
                ...
                case AnimationSlideInDirection.Right:
                    sb.AddSlideFromRight(seconds, size == 0 ? element.ActualWidth / 20 : size, keepMargin: keepMargin);
                    break;
                // Add slide from right animation
                case AnimationSlideInDirection.RightFully:
                ...
                case AnimationSlideInDirection.Top:
                    sb.AddSlideFromTop(seconds, size == 0 ? element.ActualHeight / 20 : size, keepMargin: keepMargin);
                    break;
                // Add slide from top animation
                case AnimationSlideInDirection.TopFully:
                ...
                case AnimationSlideInDirection.Bottom:
                    sb.AddSlideFromBottom(seconds, size == 0 ? element.ActualHeight / 20 : size, keepMargin: keepMargin);
                    break;
                // Add slide from bottom animation
                case AnimationSlideInDirection.BottomFully:
            ...
            await Task.Delay((int)(seconds * 1));
        }
        ...
        public static async Task SlideAndFadeOutAsync(this FrameworkElement element, AnimationSlideInDirection direction, float seconds = 0.3f, bool keepMargin = true, int size = 0)
        {
            ...
            switch (direction)
            {
                ...
                case AnimationSlideInDirection.Left:
                    sb.AddSlideToLeft(seconds, size == 0 ? element.ActualWidth / 20 : size, keepMargin: keepMargin);
                    break;
                ...
                case AnimationSlideInDirection.Right:
                    sb.AddSlideToRight(seconds, size == 0 ? element.ActualWidth / 20 : size, keepMargin: keepMargin);
                    break;
                // Add slide to right animation
                case AnimationSlideInDirection.RightFully:
                ...
                case AnimationSlideInDirection.Top:
                    sb.AddSlideToTop(seconds, size == 0 ? element.ActualHeight / 20 : size, keepMargin: keepMargin);
                    break;
                ...
                case AnimationSlideInDirection.Bottom:
                    sb.AddSlideToBottom(seconds, size == 0 ? element.ActualHeight / 20 : size, keepMargin: keepMargin);
                    break;
                // Add slide to bottom animation
                case AnimationSlideInDirection.BottomFully:
        ...
        #region Slide In New Message

        public static async Task SlideInNewMessageFromBottom(this FrameworkElement element, bool firstLoad, float seconds = 0.7f, bool keepMargin = true, int size = 0)
        {
            // Create the storyboard
            var sb = new Storyboard();

            //Add Scale From Bottom Right corner
            sb.AddingNewMessageFromBottom(element, seconds, element.ActualHeight, keepMargin: keepMargin);

            // Add fade in animation
            sb.AddFadeIn(seconds, from: true);
        ...
        public static async Task SlideInMessageFromBottom(this FrameworkElement element, bool firstLoad, float seconds = 0.7f, bool keepMargin = true, int size = 0)
        {
            // Create the storyboard
            var sb = new Storyboard();

            //Add Scale From Bottom Right corner
            sb.AddingMessageFromBottom(element, seconds, element.ActualHeight, keepMargin: keepMargin);
        ...
        #region Deleting Animation
        public static async Task DeleteAnimation(this FrameworkElement element, float seconds = 0.3f)
        {
            var sb = new Storyboard();

            sb.DeleteAnimation(seconds, element.Height);
